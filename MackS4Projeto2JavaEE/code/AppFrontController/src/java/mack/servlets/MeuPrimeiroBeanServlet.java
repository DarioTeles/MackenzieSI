...
/**
 * Descreve um Servlet para o fluxo da aplicação que utiliza o bean MeuPrimeiroBean.
 * 
 */
public class MeuPrimeiroBeanServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try (PrintWriter out = response.getWriter()) 
        {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MeuPrimeiroBeanServlet:" + meuBean.metodoDeNegocio() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    {
        return "Descreve um Servlet para o fluxo da aplicação que utiliza o bean MeuPrimeiroBean.";
    }
}
