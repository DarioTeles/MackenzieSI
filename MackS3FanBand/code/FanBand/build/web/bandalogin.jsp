<!-- 
    Document   : bandalogin.jsp
    Created on : 15/11/2016
    Author     : Dário Teles de Oliveira

    Página responsável por realizar o login da banda:
        -Action "bandaLogin" no qual direciona para banda.jsp;
        -bandacadastro.jsp.
-->
        ...
        <div class="form-front">
            ...
            <article>
                <form action="Controller" method="POST">
                    <h1 class="h3 mb-3 font-weight-normal">Gerencie os repertórios e os eventos da sua banda!</h1>
                    <label class="sr-only">E-mail: </label>
                    <input class="form-control" type="text" name="login" placeholder="Email" autofocus/>
                    <label class="sr-only">Senha: </label>
                    <input class="form-control" type="password" name="senha" placeholder="Senha" />
                    <input type="hidden" name="action" value="bandaLogin"/>
                    <input class="btn btn-lg btn-primary btn-block" type="submit" value="Login"/>
                </form>
                <form action="bandacadastro.jsp" method="POST">
